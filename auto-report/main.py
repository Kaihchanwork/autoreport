...
def send_email_bk(sender_email, receiver_email, subject, body, smtp_server, smtp_port, smtp_username, smtp_password):
...
async def run_report_and_send_email():
    ...
    receiver_emails = os.getenv('RECEIVER_EMAILS').split(',')  # Assuming READER_EMAILS is a comma-separated string
